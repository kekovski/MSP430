...
// SPI operation codes
#define ETH_SPI_RCR			0x00
#define ETH_SPI_RBM			0x3A
#define ETH_SPI_WCR			0x40
#define ETH_SPI_WBM			0x7A
#define ETH_SPI_BFS			0x80
#define ETH_SPI_BFC			0xA0
#define ETH_SPI_SRC			0xFF
#define ADDR_MASK	0x1F
#define SPRD_MASK	0x80

// Ethernet constants
#define	MAXFRAME	1518	// maximum Ethernet frame length
#define MINFRAME	60
...
typedef union _REG 
{
	...
	// MISTAT bits --------
	struct {
		unsigned char MISTAT_BUSY_BIT:1;
