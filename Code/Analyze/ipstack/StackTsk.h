...
typedef struct appConfigStruct
{
	...
	//TODO: Modified  APP_CONFIG to include TFTP server
	IP_ADDR		PrimaryTFTPServer;		// Primary TFTP Server
	WORD		BootFileSize;			// Size of the boot file size in units of 512B
	BYTE*		BootFileName;			// Pointer to the name of the boot file
	...
	struct
	{
		...
		unsigned char bTFTPInConfigMode : 1;
...
#define TFTPIsInConfigMode()	(AppConfig.Flags.bTFTPInConfigMode)
