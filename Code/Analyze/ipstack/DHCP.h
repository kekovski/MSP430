...
//TODO: Increased len by 3 to add options 150(TFTP server), 13(Boot File Size) and 67(Bootfile name)
#define DHCP_PARAM_REQUEST_LIST_LEN     (7u)	// DHCP_PARAM_REQUEST_LIST_LEN Type
...
#define DHCP_TFTP_SERVER_ADDRESS		(150u)	// DHCP TFTP Server Address option code -> See RFC5859
#define DHCP_BOOT_FILE_SIZE				(13u)	// DHCP Boot file size in units of 512B
#define DHCP_BOOT_FILE_NAME				(67u)	// DHCP Boot file name
