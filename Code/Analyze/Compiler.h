 ...
 * 29/09/2012	Modified by ME to include MSP430-specific stuff
 ********************************************************************/
#ifndef __COMPILER_H
#define __COMPILER_H

#include "ipstack/GenericTypeDefs.h"
...
// Include proper device header file
	...
	#include <p32xxxx.h>
	#include <plib.h>
#elif defined(_MSP430)	//MSP430 Compiler
	#include <msp430.h>
	#define WRONG_WDTPW 0xFFFF
#endif
...
// Base RAM and ROM pointer types for given architecture
	...
	#define PTR_BASE		unsigned short
	//TODO: Maybe add ROM_PTR_BASE define here, we'll see
#endif
...
// (PIC24F, PIC24H, dsPIC30F, dsPIC33F, and PIC32)
	...
	//MSP430-specific stuff
	#if defined(_MSP430)
		#define Reset()			WDTCTL = WRONG_WDTPW + WDTHOLD; 	//To Reset, we just write a wrong  password value in the watchdog timer
		#define Nop()			asm("NOP")
#endif
